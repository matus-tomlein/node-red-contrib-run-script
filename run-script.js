...
module.exports = function(RED) {
        ...
        this.on("input", function(msg) {
            if (msg.hasOwnProperty("kill")) {
                ...
                if (this.useSpawn === true) {
                    ...
                    child = spawn(cmd,arg, { env: msg.payload.env || {} });
                    ...
                    child = exec(cl, {encoding:'binary', maxBuffer:10000000, env: msg.payload.env || {}}, function (error, stdout, stderr) {
                        var msg2, msg3;
                        delete msg.payload;
                        if (stderr) {
    ...
    RED.nodes.registerType("run-script",ExecNode);
}
